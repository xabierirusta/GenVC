...
workflow vc_germline_wes {
    ...
    access_bed               // Access BED needed for CNVkit
    cache_dir                // Annotation cache dir for Ensembl VEP 
    normal                   // Markduplicates BAM and BAI files of the normal control
